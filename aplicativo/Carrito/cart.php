              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="#" class="btn btn-primary btn-sm btnEliminar" data-id="<?php  echo $arregloCarrito[$i]['Id'] ?>" >ÑO</a></td>
                  </tr>
          ...
          <div class="col-md-6">
            <div class="row mb-5">
              <div class="col-md-6 mb-3 mb-md-0">
                <button class="btn btn-primary btn-sm btn-block">Seguir Comprando</button>
              </div>
          ...
          <div class="col-md-6 pl-5">
            <div class="row justify-content-end">
              <div class="col-md-7">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <button class="btn btn-primary btn-lg py-3 btn-block" onclick="window.location='checkout.php'">Continuar</button>
                  </div>
                </div>
              </div>
            </div>
    ...
    $(document).ready(function(){
      $(".btnEliminar").click(function(event){
        ...
        $.ajax({
         ...
         boton.parent('td').parent('tr').remove(); location.reload(); 
        });
      });
