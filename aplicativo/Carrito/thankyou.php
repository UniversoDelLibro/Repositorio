<?php
  ...
  $conexion->query("insert into usuario (primer_nombre, telefono, email, password, segundo_nombre, primer_apellido, segundo_apellido, numero_doc) 
  values(      
    '".$_POST['c_fname']."',
    '".$_POST['c_phone']."',
  ...
  $conexion->query("insert into envios(localidad, direccion,id_venta) 
  values(
    '".$_POST['c_state_country']."',
    '".$_POST['c_address']."',
    $id_venta
