...
$datos = $conexion->query("select
     ventas.*,
    usuario.primer_nombre,usuario.primer_apellido,usuario.telefono,usuario.email
    from ventas
        ...
        <div class="row">
          ...
          <div class="col-md-7">
            ...
            <form action="#" method="post">
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_fname" class="text-black">Apellido: <?php echo $datosUsuario[5]; ?></label>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-12">
          ...
          <div class="col-md-5 ml-auto">
            ...
            <div class="p-4 border mb-3">
                <img src="./images/<?php echo $f['imagen'];?>" width="50px"7>
